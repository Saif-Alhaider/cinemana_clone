...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'D:\atom file\clone apps\cinemana_clone\Back-End\venv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'D:\atom file\clone apps\cinemana_clone\Back-End\venv\Scripts\deactivate.nu'
